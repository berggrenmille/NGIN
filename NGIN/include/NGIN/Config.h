...
namespace NGIN
{
    ...
    namespace Config
    {
         ...
         */
        NGIN_API std::string GetRawValue(const std::string& key,
                                         [[maybe_unused]] [[maybe_unused]] [[maybe_unused]] [[maybe_unused]] const std::source_location& source = std::source_location::current());
