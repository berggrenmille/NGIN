...
namespace NGIN::Meta::Reflection
{
    ...
    public:
        ...
        explicit ClassRegistrar(const std::string& className);
        ...
        ClassRegistrar<ClassType>&
        RegisterMethod(const std::string& methodName, ReturnType(ClassType::* methodPtr)(Args...));

        template<typename ReturnType, typename... Args>
        ClassRegistrar<ClassType>&
        RegisterMethod(const std::string& methodName, ReturnType(ClassType::* methodPtr)(Args...) const);
    ...
    private:
        ...
        static std::any
        InvokeMethod(ClassType* classInstance, ReturnType(ClassType::* methodPtr)(ArgTypes...), std::vector<std::any>& args);

        template<std::size_t Index = 0, typename... ArgTypes>
        static std::any
        InvokeMethod(ClassType* classInstance, void (ClassType::* methodPtr)(ArgTypes...), std::vector<std::any>& args);

        template<typename ReturnType, std::size_t Index = 0, typename... ArgTypes>
        static std::any
        InvokeMethod(ClassType* classInstance, ReturnType(ClassType::* methodPtr)(ArgTypes...) const, std::vector<std::any>& args);

        template<std::size_t Index = 0, typename... ArgTypes>
        static std::any
        InvokeMethod(ClassType* classInstance, void (ClassType::* methodPtr)(ArgTypes...) const, std::vector<std::any>& args);
    };
    ...
    {
        classData.name = TypeName<ClassType>::Class();
    ...
    ClassRegistrar<ClassType>& ClassRegistrar<ClassType>::RegisterConstructor()
    {
        ...
        {
            return static_cast<void*>(new(memoryPtr) ClassType());
        };
        return *this;
    }
    ...
    ClassRegistrar<ClassType>::RegisterProperty(const std::string& fieldName, FieldType ClassType::* fieldPtr)
    {
        ...
        fieldData.type = TypeName<FieldType>::Class();
    ...
    ClassRegistrar<ClassType>::RegisterMethod(const std::string& methodName, ReturnType(ClassType::* methodPtr)(Args...))
    {
        ...
        methodData.returnType = TypeName<ReturnType>::Class();
        ...
        methodData.invoker = std::move([methodPtr](void* instance, Args&& ... args) -> ReturnType
                                       {
                                           auto* classInstance = reinterpret_cast<ClassType*>(instance);
                                           return (classInstance->*methodPtr)(std::forward<Args>(args)...);
                                       });
    ...
    ClassRegistrar<ClassType>::RegisterMethod(const std::string& methodName, ReturnType(ClassType::* methodPtr)(Args...) const)
    {
        ...
        // Create a lambda to wrap the method
        auto lambda = [methodPtr](void* instance, Args&& ... args) -> ReturnType
        {
            auto* classInstance = reinterpret_cast<ClassType*>(instance);
            return (classInstance->*methodPtr)(std::forward<Args>(args)...);
        };

        methodData.invoker = std::move(lambda);


        classData.functions.emplace_back(methodData);
        return *this;
    }
    ...
    std::any
    ClassRegistrar<ClassType>::InvokeMethod(ClassType* classInstance, ReturnType(ClassType::* methodPtr)(ArgTypes...), std::vector<std::any>& args)
    {
        if constexpr (Index == sizeof...(ArgTypes)) // Base case
        {
            return std::any(std::apply([classInstance, methodPtr](auto&& ...unpackedArgs)
                                       {
                                           return (classInstance->*methodPtr)(
                                                   std::forward<decltype(unpackedArgs)>(unpackedArgs)...);
                                       },
                                       std::tuple<ArgTypes...>(std::any_cast<ArgTypes>(args[Index])...)));
    ...
    std::any
    ClassRegistrar<ClassType>::InvokeMethod(ClassType* classInstance, void (ClassType::* methodPtr)(ArgTypes...), std::vector<std::any>& args)
    {
        if constexpr (Index == sizeof...(ArgTypes)) // Base case
        {
    ...
    template<typename ReturnType, std::size_t Index, typename... ArgTypes>
    std::any
    ClassRegistrar<ClassType>::InvokeMethod(ClassType* classInstance, ReturnType(ClassType::* methodPtr)(ArgTypes...) const, std::vector<std::any>& args)
    {
        if constexpr (Index == sizeof...(ArgTypes)) // Base case
        {
            return std::any(std::apply([classInstance, methodPtr](auto&& ...unpackedArgs)
    ...
    template<std::size_t Index, typename... ArgTypes>
    std::any
    ClassRegistrar<ClassType>::InvokeMethod(ClassType* classInstance, void (ClassType::* methodPtr)(ArgTypes...) const, std::vector<std::any>& args)
    {
        if constexpr (Index == sizeof...(ArgTypes)) // Base case
        {
            auto tupleArgs = std::make_tuple(std::any_cast<ArgTypes>(args[Index])...);
